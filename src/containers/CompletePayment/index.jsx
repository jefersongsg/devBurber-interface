...
export function CompletePayment() {
  ...
  return (
    ...
    <div id="payment-status">
      ...
      <a id="retry-button" className="text-button" href={STATUS_CONTENT_MAP[status].url}>
        {STATUS_CONTENT_MAP[status].buttontText}
      </a>
    </div>
    </div>
  );
